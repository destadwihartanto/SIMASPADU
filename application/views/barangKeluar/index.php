						...
						<tbody id="tbody">
							...
							foreach ($bk as $bk) : ?>
								<tr>
									...
									<td><span class="badge badge-warning"></i> <?= $bk->status ?></span></td>

									<td><span class="badge badge-danger"> <i class="fa fa-minus"></i> <?= $bk->jumlah_keluar ?></span></td>
									<td>
										<center>
											<a href="<?= base_url() ?>barangKeluar/ubah/<?= $bk->id_barang_keluar ?>" class="btn btn-circle btn-success btn-sm">
												<i class="fas fa-pen"></i>
											</a>
											<a href="#" onclick="konfirmasi('<?= $bk->id_barang_keluar ?>','<?= $bk->jumlah_keluar ?>','<?= $bk->id_barang ?>')" class="btn btn-circle btn-info btn-sm">
