...
<div class="container-fluid">
	...
	<div class="row">
		...
		<!-- Earnings (Monthly) Card Example -->
		<div class="col-xl-3 col-md-6 mb-4" id="struktutal">
			<div class="card border-left-info shadow h-100 py-2">
				<div class="card-body">
					<div class="row no-gutters align-items-center">
						<div class="col mr-2">
							<div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Struktutal
							</div>
			...
			<div class="card shadow mb-4">
				<div class="card-header py-3 d-flex flex-row align-items-center justify-content-between bg-success">
					...
					<?php if ($this->session->userdata('login_session')['level'] == 'admin' || $this->session->userdata('login_session')['level'] == 'gudang') : ?>
						<a href="<?= base_url() ?>barangMasuk" class="btn btn-success btn-md btn-circle">
		...
		<div class="col-xl-4 col-md-4 mb-4" id="bkterakhir">
			<div class="card shadow mb-4">
				<div class="card-header py-3 d-flex flex-row align-items-center justify-content-between bg-danger">
					...
					<?php if ($this->session->userdata('login_session')['level'] == 'admin' || $this->session->userdata('login_session')['level'] == 'gudang') : ?>
						<a href="<?= base_url() ?>barangKeluar" class="btn btn-danger btn-md btn-circle">
							<i class="fa fa-arrow-right"></i>
						</a>
					<?php endif; ?>
				</div>
