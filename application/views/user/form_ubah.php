							...
							<div class="col-lg-12">
								...
								<div class="form-group"><label>Level</label>
									<select name="level" class="form-control">
										...
										<option value="sekertaris" <?php if ($u->level == "sekertaris") : ?> Selected <?php endif; ?>>Sekertaris</option>
										<option value="bendahara" <?php if ($u->level == "bendahara") : ?> Selected <?php endif; ?>>Bendahara</option>
									</select>
								</div>
