<?php foreach ($data as $d) : ?>
	...
	<div class="container-fluid">
		...
		<form action="<?= base_url() ?>barangMasuk/proses_ubah" name="myForm" method="POST" enctype="multipart/form-data" onsubmit="return validateForm()">
						...
						<div class="card-body">
							<div class="col-lg-12">
								...
								<div class="form-group"><label>ID Barang Masuk</label>
									<input class="form-control" name="idbm" value="<?= $d->id_barang_masuk ?>" type="text" placeholder="" autocomplete="off" readonly>
								</div>
								...
								<div class="form-group"><label>Tanggal Masuk</label>
									<input class="form-control" name="tgl" id="datepicker" value="<?= format($d->tgl_masuk) ?>" type="text" placeholder="" autocomplete="off">
								</div>

								<div class="form-group"><label>Kondisi</label>
								<select class="form-control chosen" name="kondisi" id="kondisi">
								...
								<div class="form-group"><label>Jumlah Masuk</label>
									...
									<input class="form-control" name="jmlmasuk" type="number" value="<?= $d->jumlah_masuk ?>">
								</div>
