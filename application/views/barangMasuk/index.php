						...
						<tbody id="tbody">
							...
							foreach ($bm as $bm) : ?>
								<tr>
									...
									<td>
										<center>
											<a href="<?= base_url() ?>barangMasuk/ubah/<?= $bm->id_barang_masuk ?>" class="btn btn-circle btn-success btn-sm">
												<i class="fas fa-pen"></i>
											</a>
											<a href="#" onclick="konfirmasi('<?= $bm->id_barang_masuk ?>','<?= $bm->jumlah_masuk ?>','<?= $bm->id_barang ?>')" class="btn btn-circle btn-danger btn-sm">
