<?php foreach ($data as $d) : ?>
	...
	<div class="container-fluid">
		...
		<form action="<?= base_url() ?>barang/proses_ubah" name="myForm" method="POST" enctype="multipart/form-data" onsubmit="return validateForm()">
					...
					<div class="card border-bottom-secondary shadow mb-4">
						...
						<div class="card-body">
							<div class="col-lg-12">
								...
								<!-- Rak -->
								<?php if ($jmlRak > 0) : ?>
									<div class="form-group"><label>Rak Barang</label>
										<select name="rak" class="form-control chosen">
											<?php foreach ($rak as $r) : ?>

												<?php if ($d->id_rak == $r->id_rak) : ?>
													<option value="<?= $r->id_rak ?>" selected><?= $r->nama_rak ?></option>
												<?php else : ?>
				...
				<div class="col-lg-4 mb-4">
					...
					<div class="card border-bottom-secondary shadow mb-4">
						...
						<div class="card-body">
							...
							<center>
								<div id="img">
									<img src="<?= base_url() ?>assets/upload/barang/<?= $d->foto ?>" id="outputImg" width="200" maxheight="300">
								</div>
							</center>
							<br>
