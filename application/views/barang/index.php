						...
						<tbody style="cursor:pointer;" id="tbody">
							...
							foreach ($barang as $b) : ?>
								<tr>
									...
									<td onclick="detail('<?= $b->id_barang ?>')"><img style="border-radius: 5px;" src="assets/upload/barang/<?= $b->foto ?>" alt="" width="75px"></td>
									<td onclick="detail('<?= $b->id_barang ?>')"><?= $b->nama_barang ?></td>
									<td onclick="detail('<?= $b->id_barang ?>')"><?= $b->nama_jenis ?></td>
									<td onclick="detail('<?= $b->id_barang ?>')"><?= $b->nama_rak ?></td>
