			...
			<div class="modal-content">
				...
				<div class="col-lg-12">
					...
					<div class="form-group"><label>Kode Rak</label>
						<input class="form-control" name="kode_rak" type="text" placeholder="">
					</div>

					<!-- Nama Rak -->
					<div class="form-group"><label>Nama Rak</label>
						<input class="form-control" name="nama_rak" type="text" placeholder="">
					</div>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="col-lg-12">
					...
					<!-- Kode Rak -->
					<div class="form-group"><label>kode Rak</label>
						<input class="form-control" name="kode_rak" id="kode_rak" type="text" placeholder="">
					</div>

					<!-- Nama Rak -->
					<div class="form-group"><label>Nama Rak</label>
						<input type="hidden" id="idrak" name="idrak">
						<input class="form-control" name="nama_rak" id="nama_rak" type="text" placeholder="">
					</div>
